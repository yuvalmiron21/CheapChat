...
![Styling](https://img.shields.io/badge/Tailwind_CSS-v4-38bdf8?logo=tailwind-css)
...
Unlike simple static pages, this project uses **Next.js 15 App Router** to manage:
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/YOUR_USERNAME/CheapChat-UI.git
    ```
